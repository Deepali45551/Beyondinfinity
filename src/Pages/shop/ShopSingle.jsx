...
const ShopSingle = () => {
  ...
  const relatedProducts = [
    { name: "Sunglasses", price: 90, img: "🕶️" },
    { name: "Cap", price: 16, img: "🧢", sale: true },
    { name: "Beanie", price: 18, img: "🧶", sale: true },
    { name: "Another Beanie", price: 18, img: "🧶", sale: true },
  ];
    ...
    <div className="bg-black min-h-screen text-white px-6 py-18">
      ...
      <div className="max-w-5xl mx-auto mt-10 border-t border-gray-700 pt-6">
        <div className="flex gap-4 mb-4">
          ...
          <button
            className={`px-3 py-1 text-sm ${activeTab === "additional"
              ? "bg-red-600 text-white"
              : "bg-black border border-gray-700"
              }`}
        ...
        <div className="text-gray-400 text-sm">
          ...
          {activeTab === "additional" && (
            <p>Additional info about the product can go here.</p>
          )}
      ...
      <div className="max-w-5xl mx-auto mt-12">
        <h2 className="text-lg font-semibold mb-6">Related products</h2>
        <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
          {relatedProducts.map((item, idx) => (
            <div key={idx} className="relative border border-gray-700 bg-black">
              {item.sale && (
                <span className="absolute top-2 left-2 bg-red-600 text-white text-xs px-2 py-1">
                  Sale
                </span>
              ...
              <div className="p-3">
                ...
                <button
                  ...
                  className="mt-2 w-full border border-gray-700 py-1 text-sm hover:bg-gray-800"
                >
                  Add to cart
                </button>
              </div>
